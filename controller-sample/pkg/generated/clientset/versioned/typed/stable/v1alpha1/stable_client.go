...
import (
	...
	"github.com/sunnyh1220/keight-dev/controller-sample/pkg/generated/clientset/versioned/scheme"
...
// StableV1alpha1Client is used to interact with features provided by the stable.sunnyh.easy group.
type StableV1alpha1Client struct {
	restClient rest.Interface
}

func (c *StableV1alpha1Client) CronTabs(namespace string) CronTabInterface {
