...
import (
	"github.com/sunnyh1220/keight-dev/etcd-operator/api/v1alpha1"
...
var (
	EtcdClusterLabelKey       = "etcd.sunnyh.easy/etcdcluster"
	EtcdClusterCommonLabelKey = "app"
	EtcdDataDirName           = "datadir"
)

// MutateStatefulSet 根据EtcdCluster对象生成StatefulSet对象
func MutateStatefulSet(ec *v1alpha1.EtcdCluster, sts *appsv1.StatefulSet) {
...
func newContainers(ec *v1alpha1.EtcdCluster) []corev1.Container {
			...
			Env: []corev1.EnvVar{
				{
					...
					Value: strconv.Itoa(int(*ec.Spec.Replicas)),
				},
				{
					Name:  "SET_NAME",
					Value: ec.Name,
...
// MutateHeadlessService 根据EtcdCluster对象生成无头Service对象
func MutateHeadlessService(ec *v1alpha1.EtcdCluster, svc *corev1.Service) {
